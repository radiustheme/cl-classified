...
<div class="rtcl rtcl-search rtcl-search-inline">
    ...
    echo esc_url( Functions::get_filter_form_url() ); ?>"
          class="form-vertical rtcl-widget-search-form rtcl-search-inline-form cl-classified-listing-search-form rtin-style-<?php
          echo esc_attr( $style ); ?>">
        <?php
        if ( ! empty( Options::$options['banner_search_location'] ) ): ?>
            ...
            if ( 'local' === Functions::location_type() ):
                ...
                echo esc_attr( $loc_class ); ?>">
                    <label for="<?php echo esc_attr( $loc_id ); ?>"><?php
                        esc_html_e( 'Where is it?', 'cl-classified' ); ?></label>
                        ...
                        if ( $style == 'suggestion' ): ?>
                            <div class="rtcl-search-input-button cl-classified-search-style-2 rtin-location">
                                <input type="text" data-type="location" class="rtcl-autocomplete rtcl-location"
                                       ...
                                       value="<?php
                                       echo $selected_location ? $selected_location->name : '' ?>">
                                <input type="hidden" name="rtcl_location"
                                       value="<?php
                                       echo $selected_location ? $selected_location->slug : '' ?>">
                            </div>
                        <?php
                        ...
                        <?php
                            ...
                            <div class="rtcl-search-input-button rtcl-search-input-location">
                                <span class="cl-input-icon">
                                    <img src="<?php
                                    echo esc_url( Helper::get_img( 'map.svg' ) ); ?>" alt="icon"/>
                                </span>
                    ...
                    <div class="form-group">
                        <div class="rtcl-search-input-button cl-classified-search-style-2 rtin-location rtcl-geo-address-field">
                            <input type="text" name="geo_address" autocomplete="off"
                                   value="<?php
                                   echo ! empty( $_GET['geo_address'] ) ? esc_attr( $_GET['geo_address'] ) : '' ?>"
                                   placeholder="<?php
                            ...
                            <input type="hidden" class="latitude" name="center_lat"
                                   value="<?php
                                   echo ! empty( $_GET['center_lat'] ) ? esc_attr( $_GET['center_lat'] ) : '' ?>">
                            <input type="hidden" class="longitude" name="center_lng"
                                   value="<?php
                                   echo ! empty( $_GET['center_lng'] ) ? esc_attr( $_GET['center_lng'] ) : '' ?>">
                        </div>
                    </div>
                </div>
                <?php
        ...
        if ( ! empty( Options::$options['banner_search_category'] ) ):
            ...
            echo esc_attr( $cat_class ); ?>">
                <div class="form-group">
                    <label for="<?php echo esc_attr( $cat_id ); ?>"><?php
                        esc_html_e( 'In which category?', 'cl-classified' ); ?></label>
                    <?php
                    ...
                    <?php
                        ...
                        <div class="rtcl-search-input-button rtcl-search-input-category">
                            <span class="cl-input-icon">
                                <img src="<?php
                                echo esc_url( Helper::get_img( 'grid.svg' ) ); ?>" alt="icon"/>
                            </span>
        ...
        if ( ! empty( Options::$options['banner_search_type'] ) ): ?>
            ...
            echo esc_attr( $typ_class ); ?>">
                <div class="form-group">
                    <label><?php
                        esc_html_e( 'In which type?', 'cl-classified' ); ?></label>
                    <div class="rtcl-search-input-button rtcl-search-input-type">
                        ...
                        <div class="dropdown cl-classified-listing-search-dropdown">
                            <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                ...
                                esc_html_e( 'Select Type', 'cl-classified' ); ?></button>
        ...
        if ( ! empty( Options::$options['banner_search_keyword'] ) ): ?>
            ...
            echo esc_attr( $key_class ); ?>">
                ...
                ?>
                <div class="form-group">
                    <label for="rtcl-keyword-search"><?php
                        esc_html_e( 'What are you looking for?', 'cl-classified' ); ?></label>
                    <div class="<?php
