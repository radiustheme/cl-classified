...
class Listing_Archive_Layout extends Customizer {
	...
	public function register_listing_archive_layout_controls( $wp_customize ) {
		...
		$wp_customize->add_control(
			new Image_Radio(
				...
				[
					...
					'description' => esc_html__( 'Select the default template layout for listing archive', 'cl-classified' ),
		...
		// Menu Alignment
		$wp_customize->add_setting(
			'listing_archive_menu_alignment',
			[
		...
		// Banner Search
		$wp_customize->add_setting(
			'listing_archive_banner_search',
			[
				'default'           => $this->defaults['listing_archive_banner_search'],
				'transport'         => 'refresh',
				'sanitize_callback' => 'rttheme_text_sanitization',
			]
		);
		...
		$wp_customize->add_control(
			...
			[
				...
				'description' => esc_html__( 'Listing Archive Content Padding Top ', 'cl-classified' ),
				'section'     => 'listing_archive_layout_section',
				'type'        => 'text',
			]
		);
		...
		$wp_customize->add_control(
			...
			[
				...
				'description' => esc_html__( 'Listing Archive Content Padding Bottom', 'cl-classified' ),
				'section'     => 'listing_archive_layout_section',
				'type'        => 'text',
			]
		);
